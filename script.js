function initCanvas() {
    ...
    // fondo del espacio y nave Image
    backgroundImage.src = "images/background-pic.jpg"; //fondo 2
    naveImage.src = "images/spaceship-pic.png"; //Foto del espacio
    // Enemigos fotos
    enemiespic1.src = "images/enemigo1.png";
    enemiespic2.src = "images/enemigo2.png"; //Enemigo2
    ...
    function Launcher() {
        ...
        this.render = function () {
            ...
            ctx.drawImage(backgroundImage, 10, 10); // fondo image
            ...
            for (var i = 0; i < this.misiles.length; i++) {
                ...
                if (m.y <= 0) { //Si un misil pasa los límites del lienzo, retíralo.
                    this.misiles.splice(i, 1); // empalme ese misil fuera de la matriz de misiles
                }
            }
            ...
            if (enemies.length === 0) {
                ...
                ctx.fillText('¡QUE ANIMAL! ¡Ganastes!', cW * .5 - 80, 50);
            }
        }
        ...
        this.hitDetect = function (m, mi) {
            ...
            for (var i = 0; i < enemies.length; i++) {
                ...
                if (m.x + m.w >= e.x &&
                    ...
                    m.y >= e.y &&
                    m.y <= e.y + e.h) {
                    this.misiles.splice(this.misiles[mi], 1); // Remover el misíl
                    enemies.splice(i, 1); // Remove el enemigo
                    document.querySelector('.barra').innerHTML = "Destruidos "  + e.  id + " ";//CONTADOR DE MUERT ES
                }
            }
        }
        ...
        this.hitDetectLowerLevel = function (enemy) {
            ...
            if (enemy.y > 550) {
                ...
                this.gameStatus.message = 'Perdiste Basura!';
            }
